...
L["DebugDescription"] =
    "|cfff00000These are debug settings for the developer, do NOT change them unless you know what you are doing."
...
L["EnableBBTDescription"] =
    "Enables or disables BigBrainTanking both now and also on login."
...
L["EnableBBTSalvRemovalDescription"] =
    "Enables or disables automatic salvation removal."
L["SalvRemoved"] = "[BBT] Salvation removed!"
L["SalvLock"] =
    "[BBT] |cfff00000WARNING: Salvation can't be removed in combat! It is on you!"
...
L["WS_CUSTOM_CHANNELS_DESC"] =
    "Enter comma separated channel names. (Example: channel1, channel2, channel3)"
...
L["EnableBBTWarningsDescription"] =
    "Enables or disables warnings about taunt resists, mocking blow misses, etc."

L["EnableBBTWarningsExpiration"] = "Enable expiration warnings"
L["EnableBBTWarningsExpirationDescription"] =
    "Enables or disables expiration warning announcements about shield wall and last stand."
...
L["ANNOUNCEMENT_LS_ACTIVATION"] =
    "- I activated $sn! In $sd seconds I will lose $lshpHP! -";
L["ANNOUNCEMENT_SW_ACTIVATION"] =
    "- I activated $sn and will be taking 75% less damage for $sd seconds! -";
L["ANNOUNCEMENT_LG_ACTIVATION"] =
    "- I activated Lifegiving Gem! In $sd seconds I will lose $hpHP! -";
L["ANNOUNCEMENT_CS_ACTIVATION"] =
    "- I activated $sn! I will need a lot of healing for $sd seconds! -";
